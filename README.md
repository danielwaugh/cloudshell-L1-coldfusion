...
### **Lepton ColdFusion L1 Shell**
Lepton ColdFusion L1 Shell provides you with the capability to communicate with network topology managed by the Lepton ColdFusion switch.
...
### Standard version
The Lepton ColdFusion Shell is based on the [**Layer 1 Switch Shell Standard**](https://github.com/QualiSystems/shell-L1-template).

### Requirements

Release: **Lepton ColdFusion L1 Shell**
...
**To import and configure the shell in CloudShell:**
  ...
  *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers*
  ...
  4. Import the new data model.
      ...
      2. Select the *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-coldfusion\datamodel\coldfusion_ResourceConfiguration.xml* file.
      3. Click **Open**.
  ...
  5. Create an L1 resource.
      ...
      4. Ensure that the correct **Model** Coldfusion Chassis and **Driver** COLDFUSION are selected.
      5. Click **OK**.
...
The *install_driver.bat* script creates a virtual environment on the Quali Server machine under *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-coldfusion* and installs the required dependencies in this virtual environment from the extracted L1 shell folder (under *~cloudshell-L1-coldfusion\packages*).
...
5. Copy the upgraded shell's datamodel file from:
	...
	*C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-coldfusion\datamodel\coldfusion_ResourceConfiguration.xml*
